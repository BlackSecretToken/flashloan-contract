...
contract FlashLoan is FlashLoanReceiverBaseV1 {
    ...
    function dualDexTrade(address _router1, address _router2, address _token1, address _token2, uint256 _amount) private onlyOwner {
    ...
    /**
        _asset: address of the asset you want to flash loan: exampe: for Ether: 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE
        _router1: first swap router
        _router2: second swap router
        _amount: how much of _asset you want to borrow
        _targetToken: address of the targetToken for swap.
     */
    function flashloan(address _asset, address _router1, address _router2, uint256 _amount, address _targetToken) public onlyOwner {
        bytes memory data = "";
        
        amount = _amount;
        asset = address(_asset);
        router1 = address(_router1);
        router2 = address(_router2);
        ...
        override
    {
        ...
        dualDexTrade(router1, router2, asset, targetToken, amount);
